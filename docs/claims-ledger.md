...
但以下项目仍按实际情况保持 `PENDING / NOT_RUN / NOT_MEASURED`：
...
rc.5 full acceptance / overall 是 `INCONCLUSIVE`，不得提升为 Windows full-matrix PASS、Qoder/Intel evidence
或 final publication readiness。
