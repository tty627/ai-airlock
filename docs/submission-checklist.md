...
- [ ] 保存脱敏 transcript、工具轨迹、环境、设置 hash 与未经剪辑原片。
...
- [x] GitHub / source repository URL：`https://github.com/tty627/ai-airlock`；本 candidate 提交不自证 post-push 操作，以远端 tag、CI 与 fresh-clone 外部结果为准。
